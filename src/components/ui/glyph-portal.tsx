...
export default function GlyphPortal({
  ...
  // Diverges from upstream, which accumulated the offset in a mutable local:
  // react-hooks/immutability rejects reassignment during render. Same result —
  // each glyph's index is where it starts in the string, which is not its
  // position in the array once astral characters are involved.
